...
st.set_page_config(page_title="Relay Dahboard", layout="wide")
...
if uploaded_file:
    ...
    for i in range(chart_count):
        ...
        msg = f"'{max_group}' has the highest {value_col} with {percent}% of the total." if chart_type != "Line Chart" else f"'{max_group}' shows the peak {value_col} with {percent}% share."
